...
function genGraphs() {
  ...
  filterPos = {
    filterLabelXOffset:    -5,
    filterLabelYOffset:    -5,
  };
  if (isSmallScreen()) {
    filterPos = {
      filterLabelXOffset:    -8,
      filterLabelYOffset:    15,
    };  
  }
  surfGraph.setOptions(filterPos);
...
function chartInit(chartID){
  nv.addGraph(function() {
    ...
    chart.legend.margin({"left": -50}).padding(22);
...
function isSuperSmallScreen() {
  return (screen.width<355);
}
...
function friedmann(omega, keyPhrase="", color=getRandomColor()){
  ...
  if(keyPhrase == "") {
    if(isSuperSmallScreen()) {
      keyPhrase = "Line "+seriesNum;
    }
    else   {
      keyPhrase = "Series "+seriesNum;
    }
  }
...
$("#view-animation-btn").click(function() {
  ...
  $(".disp-grp-1").css('display','none');
  $(".disp-grp-2").css('display','block');
...
$("#view-chart-btn").click(function() {
  stopAnimation();
  $(".disp-grp-1").css('display','block');
  $(".disp-grp-2").css('display','none');
});
...
$(".page-right").click(function() {
  ...
  if($(this).parent().parent().hasClass('helptip-small-main')) {
    var height = $(".helptip-small-main").outerHeight();
    $(".helptip-small-main").css('margin-top',"-"+(height-6) +"px");  
  }
});
...
$(".helptip-small").mouseenter(function() {
  var height = $(".helptip-small-main").outerHeight();

  $(".helptip-small-main").css('margin-top',"-"+(height-6) +"px");  
  $(".helptip-small-main").addClass("helptip-small-active");
  $(".helptip-small-chevron").addClass("helptip-small-chevron-active");
});

$(document).on("mouseleave", ".helptip-small-active", function() {
  $(this).removeClass("helptip-small-active");
  $(".helptip-small-chevron").removeClass("helptip-small-chevron-active");
});